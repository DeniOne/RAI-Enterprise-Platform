---
id: DOC-FRN-10-FRONTEND-MENU-IMPLEMENTATION-01-MENU-JLLC
layer: Frontend
type: Menu Map
status: draft
version: 0.1.0
...
- Следующий milestone: DONE (закрытие server-driven CRM-метрик и e2e по ключевым кнопкам)
...
- Добавлено в текущем цикле:
  ...
  - рабочая группа esults/*` (хаб + подроуты);
...
- Все виджеты кликабельны и ведут в соответствующие разделы (`plans`, `execution`, `deviations`, esults`).
...
## 8. Ссылки на TD-ID в 99_TECH_DEBT_CHECKLIST.md
