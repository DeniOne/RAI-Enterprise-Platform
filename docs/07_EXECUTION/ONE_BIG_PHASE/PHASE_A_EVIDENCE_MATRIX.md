...
| `A5` | `IP / chain-of-title` | доказать права на код, БД и know-how | accepted `ELP-20260328-09` + repo-derived source register + collection packet + owner handoff по evidence-классам | [OSS_LICENSE_AND_IP_REGISTER.md](/root/RAI_EP/docs/05_OPERATIONS/OSS_LICENSE_AND_IP_REGISTER.md), [PHASE_A5_CHAIN_OF_TITLE_SOURCE_REGISTER.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A5_CHAIN_OF_TITLE_SOURCE_REGISTER.md), [PHASE_A5_CHAIN_OF_TITLE_COLLECTION_PACKET.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A5_CHAIN_OF_TITLE_COLLECTION_PACKET.md), [PHASE_A5_CHAIN_OF_TITLE_HANDOFF_PACKET.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A5_CHAIN_OF_TITLE_HANDOFF_PACKET.md), `pnpm phase:a5:chain-of-title`, `pnpm phase:a5:chain-of-title:collection`, `pnpm phase:a5:chain-of-title:handoff`, RF review | signed IP artifacts и chain-of-title pack | `repo-side source map, collection packet и owner handoff собраны, внешне не подтверждено` |
