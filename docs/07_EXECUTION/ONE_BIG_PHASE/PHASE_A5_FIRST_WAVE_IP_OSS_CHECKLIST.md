...
- `pnpm security:licenses` -> `total_packages=189`, `unknown_licenses=33`
...
### Шаг 1. Оттриажить `33 unknown licenses`
...
- `unknown licenses` разбиты по triage-классам;
- notice/obligations perimeter описан;
