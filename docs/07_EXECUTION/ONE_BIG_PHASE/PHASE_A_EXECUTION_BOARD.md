...
| `A2` | `A-2.3.1` | Разобрать критичные и высокие зависимости security baseline | `security / AppSec + backend / platform` | `open` | [ENTERPRISE_EVIDENCE_MATRIX_2026-03-28.md](/root/RAI_EP/docs/_audit/ENTERPRISE_EVIDENCE_MATRIX_2026-03-28.md), `pnpm security:audit:ci` | выделить top critical/high packages и начать remediation по убыванию риска |
