...
| `A3` | `A-2.4.3` | Определить действия, которые агент может только советовать | `AI governance / product` | `in_progress` | [PHASE_A3_ADVISORY_ONLY_REGISTER.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A3_ADVISORY_ONLY_REGISTER.md), [RAI_EP_AI_GOVERNANCE_AND_AUTONOMY_POLICY.md](/root/RAI_EP/docs/04_AI_SYSTEM/RAI_EP_AI_GOVERNANCE_AND_AUTONOMY_POLICY.md) | связать advisory-only register с UX/runtime semantics и не дать этому perimeter стать скрытым execute-path |
| `A3` | `A-2.4.4` | Довести формальный набор safety/eval-проверок | `AI governance / testing` | `in_progress` | [PHASE_A3_RELEASE_EVAL_SUITE.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A3_RELEASE_EVAL_SUITE.md), [PHASE_A3_RUNTIME_DRILL_REPORT_2026-03-31.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A3_RUNTIME_DRILL_REPORT_2026-03-31.md), [AI_AGENT_FAILURE_SCENARIOS_2026-03-28.md](/root/RAI_EP/docs/_audit/AI_AGENT_FAILURE_SCENARIOS_2026-03-28.md) | собрать unified evaluator script и machine-readable release gate поверх уже подтверждённых runtime-drill |
...
| `A4` | `A-2.5.3` | Проверить, что install/restore повторяется без скрытых знаний | `platform / ops` | `in_progress` | [PHASE_A4_INSTALL_DRY_RUN_REPORT_2026-03-31.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A4_INSTALL_DRY_RUN_REPORT_2026-03-31.md), [PHASE_A4_BACKUP_RESTORE_EXECUTION_REPORT_2026-03-31.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A4_BACKUP_RESTORE_EXECUTION_REPORT_2026-03-31.md), [PHASE_A4_SELF_HOST_INSTALL_UPGRADE_PACKET.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A4_SELF_HOST_INSTALL_UPGRADE_PACKET.md), [ENTERPRISE_DUE_DILIGENCE_2026-03-28.md](/root/RAI_EP/docs/_audit/ENTERPRISE_DUE_DILIGENCE_2026-03-28.md) | провести fresh-host rehearsal без pre-existing `.env`, убрать obsolete compose warning и после этого пересчитать скрытые знания повторно |
| `A4` | `A-2.5.4` | Не считать продукт pilot-ready без installability и support boundary | `techlead / ops` | `guard_active` | [RAI_EP_ENTERPRISE_RELEASE_CRITERIA.md](/root/RAI_EP/docs/05_OPERATIONS/RAI_EP_ENTERPRISE_RELEASE_CRITERIA.md), [PHASE_A4_SUPPORT_BOUNDARY_PACKET.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A4_SUPPORT_BOUNDARY_PACKET.md) | держать `Tier 1` закрытым, пока install/restore execution evidence и operational boundary не подтверждены |
| `A5` | `A-2.6.1` | Разобрать `unknown licenses` и собрать working obligations perimeter | `legal / compliance + backend / platform` | `in_progress` | [PHASE_A5_UNKNOWN_LICENSE_TRIAGE_REGISTER.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A5_UNKNOWN_LICENSE_TRIAGE_REGISTER.md), [PHASE_A5_NOTICE_OBLIGATIONS_PACKET.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A5_NOTICE_OBLIGATIONS_PACKET.md), [PHASE_A5_NOTICE_BUNDLE_REPORT_2026-03-31.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A5_NOTICE_BUNDLE_REPORT_2026-03-31.md), [OSS_LICENSE_AND_IP_REGISTER.md](/root/RAI_EP/docs/05_OPERATIONS/OSS_LICENSE_AND_IP_REGISTER.md), `pnpm security:licenses` -> `unknown: 33 -> 31`, `UNLICENSED=2`, `pnpm security:notices` -> `PASS` | дать final legal classification для `esbuild/turbo` toolchain companions, удержать `fsevents` вне Linux `Tier 1` perimeter и привязать assembled notice bundle к procurement/distribution decision |
