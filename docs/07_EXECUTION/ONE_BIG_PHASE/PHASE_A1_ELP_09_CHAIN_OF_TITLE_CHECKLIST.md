...
7. Открыть `var/compliance/phase-a5-chain-of-title-request-packet.md`.
8. Раздать owner packets по очередям владельцев.
