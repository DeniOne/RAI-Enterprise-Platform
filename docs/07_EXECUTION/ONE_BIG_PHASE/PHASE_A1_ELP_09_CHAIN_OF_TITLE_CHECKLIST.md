...
6. Открыть `var/compliance/phase-a5-chain-of-title-handoff.md`.
7. Раздать owner packets по очередям владельцев.
8. Собрать список employment/contractor/IP transfer документов по owner queues.
9. Проверить, нет ли пробелов по first-party code и database rights.
10. Сохранить внешний файл.
11. Выполнить:
