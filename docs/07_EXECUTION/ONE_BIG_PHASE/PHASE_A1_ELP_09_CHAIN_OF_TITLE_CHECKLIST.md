...
3. Собрать список employment/contractor/IP transfer документов.
4. Проверить, нет ли пробелов по first-party code и database rights.
