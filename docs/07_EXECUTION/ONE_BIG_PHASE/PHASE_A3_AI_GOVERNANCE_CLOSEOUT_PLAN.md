...
- опубликован runtime-derived [PHASE_A3_HITL_MATRIX.md](/root/RAI_EP/docs/07_EXECUTION/ONE_BIG_PHASE/PHASE_A3_HITL_MATRIX.md) как текущая human approval ladder для `Tier 1`;
