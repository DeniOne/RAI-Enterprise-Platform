...
- Present: `governanceMachine`, `useGovernanceAction`, `pending/escalation/techcouncil` flows.
- Gaps: missing full integration test harness for frontend FSM flows.

3. Phase 3 (Escalation & TechCouncil): Mostly complete.
- Present: `EscalationBanner`, `QuorumVisualizer` (TechCouncil UI), escalation states.
