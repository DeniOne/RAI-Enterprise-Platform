...
- [ ] Собрать каноническое меню/входные точки для `Telegram`.
...
- [ ] Привязать фото, гео, голос, документы и таблицы к action flow.
...
- [ ] Агент должен уметь создавать привязанный operational object.
...
- минимальный Telegram action shell;
