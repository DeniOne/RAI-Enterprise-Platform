---
id: DOC-ARC-DATABASE-MODEL-SCOPE-MANIFEST-1W53
layer: Architecture
type: HLD
status: draft
version: 0.1.0
...
| `FrontOfficeHandoffRecord` | `crm_commerce` | `mixed-transition` | `tenantId + threadId + id` | `required` | `phase_7` | `no` | `no` | `phase_7` | `handoff control surface for wave-1` |
| `FrontOfficeThread` | `crm_commerce` | `mixed-transition` | `tenantId + companyId + threadKey` | `required` | `phase_7` | `no` | `no` | `phase_7` | `first operational aggregate migration wave` |
| `FrontOfficeThreadMessage` | `crm_commerce` | `mixed-transition` | `tenantId + threadId + id` | `required` | `phase_7` | `no` | `no` | `phase_7` | `shadow-write via parent thread scope` |
| `FrontOfficeThreadParticipantState` | `crm_commerce` | `mixed-transition` | `tenantId + threadId + userId` | `required` | `phase_7` | `no` | `no` | `phase_7` | `participant seam for operator inbox` |
