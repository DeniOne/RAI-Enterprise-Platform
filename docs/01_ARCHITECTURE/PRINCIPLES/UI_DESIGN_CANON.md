...
|---------|--------|-----------|
| Заголовок страницы | `20px` | `text-xl` |
| Подзаголовок страницы (описание) | `14px` | `text-sm` |
| Подзаголовок секции | `24px` | `text-2xl` |
| Заголовок карточки | `20px` | `text-xl` |
| Основной текст | `16px` | `text-base` |
| Вспомогательный текст | `14px` | `text-sm` |
| Мелкий текст | `12px` | `text-xs` |

**Плотность заголовочного блока (обязательная):**
- Заголовок страницы: `text-xl font-medium text-gray-900`
- Описание под заголовком: `mt-1 text-sm font-normal text-gray-500`
...
| Между заголовком страницы и описанием | `4px` | `mt-1` |
