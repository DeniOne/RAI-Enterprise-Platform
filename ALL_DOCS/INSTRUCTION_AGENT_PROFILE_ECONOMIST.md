---
id: DOC-INS-AGENT-PROFILES-INSTRUCTION-AGENT-PROFILE-E-15U6
layer: Instructions
type: Instruction
status: approved
version: 1.1.0
...
- `Runtime Governance` как canonical runtime role с quality/reliability contour;
- `Control Tower` как часть ranking, telemetry и queue health;
- `Lifecycle Board` как canonical agent with freeze/retire state.
