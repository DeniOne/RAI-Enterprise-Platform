    ...
    describe('create', () => {
        it('should throw ForbiddenException if client does not belong to company', async () => {
            ...
            await expect(service.create({
                ...
                clientId: 'client-1',
                companyId: 'company-1',
            }, 'company-1')).rejects.toThrow(ForbiddenException);
        });

        it('should throw BadRequestException for invalid GeoJSON', async () => {
            prismaMock.client.findFirst.mockResolvedValue({ id: 'client-1', companyId: 'company-1' });
            ...
            await expect(service.create({
                ...
                clientId: 'client-1',
                companyId: 'company-1',
            }, 'company-1')).rejects.toThrow(BadRequestException);
        });
