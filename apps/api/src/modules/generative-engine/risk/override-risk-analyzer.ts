...
import { RiskMetricCalculator, RiskInput, RiskOutput } from './risk-metric-calculator';
...
export class OverrideRiskAnalyzer {
    ...
    analyze(input: OverrideAnalysisInput): OverrideAnalysisResult {
        ...
        try {
            ...
            aiRisk = { yieldRisk: 0, financialRisk: 0, complianceRisk: 0, aggregated: 0 };
            humanRisk = { yieldRisk: 0, financialRisk: 0, complianceRisk: 0, aggregated: 0 };
        }
