...
import { TechnologyCard, User } from '@prisma/client';

@Injectable()
export class TechnologyCardService {
    constructor(private readonly prisma: PrismaService) { }

    async create(input: CreateTechnologyCardInput, user: User, companyId: string): Promise<any> {
     ...
     */
    async applyToSeason(seasonId: string, cardId: string, user: User, companyId: string): Promise<any> {
