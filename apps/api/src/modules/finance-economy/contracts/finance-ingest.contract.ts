...
export const FINANCE_INGEST_SUPPORTED_VERSIONS = [FINANCE_INGEST_CONTRACT_VERSION] as const;

type IntegrationSource = 'TASK_MODULE' | 'HR_MODULE' | 'CONSULTING_ORCHESTRATOR';
...
export function buildFinanceIngestEvent(input: BaseContractInput): IngestEconomicEventDto {
