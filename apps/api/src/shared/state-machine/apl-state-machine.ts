...
const APL_TRANSITIONS: TransitionDef<AplStage, AplEvent>[] = [
  ...
  {
    from: AplStage.SOIL_PREPARATION,
    event: AplEvent.ADVANCE,
    to: AplStage.FERTILIZATION_BASE,
  },
  {
    from: AplStage.FERTILIZATION_BASE,
    event: AplEvent.ADVANCE,
    to: AplStage.SEED_PREPARATION,
  },
  {
    from: AplStage.SEED_PREPARATION,
    event: AplEvent.ADVANCE,
    to: AplStage.SOWING,
  },
  {
    from: AplStage.SOWING,
    event: AplEvent.ADVANCE,
    to: AplStage.PRE_EMERGENCE,
  },
  {
    from: AplStage.PRE_EMERGENCE,
    event: AplEvent.ADVANCE,
    to: AplStage.GERMINATION,
  },
  { from: AplStage.GERMINATION, event: AplEvent.ADVANCE, to: AplStage.ROSETTE },
  {
    from: AplStage.ROSETTE,
    event: AplEvent.ADVANCE,
    to: AplStage.STEM_ELONGATION,
  },
  {
    from: AplStage.STEM_ELONGATION,
    event: AplEvent.ADVANCE,
    to: AplStage.BUDDING,
  },
  { from: AplStage.BUDDING, event: AplEvent.ADVANCE, to: AplStage.FLOWERING },
  {
    from: AplStage.FLOWERING,
    event: AplEvent.ADVANCE,
    to: AplStage.POD_FORMATION,
  },
  {
    from: AplStage.POD_FORMATION,
    event: AplEvent.ADVANCE,
    to: AplStage.MATURATION,
  },
  {
    from: AplStage.MATURATION,
    event: AplEvent.ADVANCE,
    to: AplStage.FULL_MATURITY,
  },
  {
    from: AplStage.FULL_MATURITY,
    event: AplEvent.ADVANCE,
    to: AplStage.DESICCATION,
  },
  { from: AplStage.DESICCATION, event: AplEvent.ADVANCE, to: AplStage.HARVEST },
  {
    from: AplStage.HARVEST,
    event: AplEvent.ADVANCE,
    to: AplStage.POST_HARVEST,
  },

  // Optional: Skip desiccation (direct to harvest)
  {
    from: AplStage.FULL_MATURITY,
    event: AplEvent.SKIP_DESICCATION,
    to: AplStage.HARVEST,
  },
];
 ...
 */
class AplStateMachineImpl implements StateMachine<
  SeasonEntity,
  AplStage | null,
  AplEvent
> {
