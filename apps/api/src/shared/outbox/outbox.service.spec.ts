...
describe('OutboxService tenant contract', () => {
    ...
    it('rejects event creation without companyId by default', () => {
        expect(() =>
            service.createEvent('agg-1', 'EconomicEvent', 'finance.economic_event.created', {
    ...
    it('allows event creation with companyId', () => {
        const outbox = service.createEvent('agg-1', 'EconomicEvent', 'finance.economic_event.created', {
            companyId: 'c1',
            economicEventId: 'evt-1',
        });
