...
export class CertAuditService {
  ...
  async logSignatureIntent(params: {
    ...
    this.logger.log(
      `SIGNATURE_INTENT: process=${params.initiatorProcess}, hash=${params.snapshotHash}`,
    );
  ...
  async logSignatureCompleted(params: {
    ...
    this.logger.log(
      `SIGNATURE_COMPLETED: process=${params.initiatorProcess}, hash=${params.snapshotHash}`,
    );
  ...
  async logSignatureError(params: {
    ...
    this.logger.error(
      `SIGNATURE_ERROR: process=${params.initiatorProcess}, hash=${params.snapshotHash} | Reason: ${params.errorReason}`,
    );
