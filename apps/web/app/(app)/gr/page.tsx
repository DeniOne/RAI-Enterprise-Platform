    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                    <h3 className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-medium mb-3">Субсидии</h3>
                    <p className="text-4xl font-medium">0</p>
                </Card>
                <Card>
                    <h3 className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-medium mb-3">Проверки</h3>
                    <p className="text-4xl font-medium">0</p>
                </Card>
                <Card>
                    <h3 className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-medium mb-3">Лицензии</h3>
                    <p className="text-4xl font-medium">0</p>
                </Card>
            </div>
