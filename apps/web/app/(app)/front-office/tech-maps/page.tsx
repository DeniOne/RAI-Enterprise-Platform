...
export default async function FrontOfficeTechMapsPage() {
  ...
  return (
    <Card>
      ...
      <p className="mt-1 text-sm text-gray-500">Проекция техкарт и их конечных статусов для хозяйства.</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">{formatStatusLabel(item.status)} • версия {item.version}</p>
                </div>
