...
import { formatFrontOfficeIntentLabel, formatFrontOfficeText } from "@/lib/ui-language";
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <Card>
        ...
        <p className="mt-1 text-sm text-gray-500">Запросы на консультации, привязанные к конкретным объектам хозяйства.</p>
      ...
      <Card>
        ...
        <p className="mt-1 text-sm text-gray-500">Накопление рабочей памяти по хозяйству, полям и сезонам.</p>
        <div className="mt-6 space-y-3">
