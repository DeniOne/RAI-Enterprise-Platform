...
export default async function FrontOfficeTasksPage() {
  ...
  return (
    <Card>
      ...
      <p className="mt-1 text-sm text-gray-500">Мои текущие и ожидающие задачи в контуре фронт-офиса.</p>
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">{task.field?.name ?? "Без поля"} • {formatStatusLabel(task.status)}</p>
                </div>
