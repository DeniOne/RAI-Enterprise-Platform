...
// =============================================================================
router.get('/locations', authenticate, (req, res) => ofs_controller_1.default.getLocations(req, res));
router.get('/positions', authenticate, (req, res) => ofs_controller_1.default.getPositions(req, res));
