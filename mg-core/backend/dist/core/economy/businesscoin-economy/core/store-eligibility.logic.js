...
exports.evaluateStoreEligibility = evaluateStoreEligibility;
 ...
 */
function evaluateStoreEligibility(context) {
    ...
    const usableMCs = mcSnapshot.filter(mc => (0, store_eligibility_guards_1.isMCUsableForStore)(mc, timestamp));
    // 2. Sum amount
