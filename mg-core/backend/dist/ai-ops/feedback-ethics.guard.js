...
exports.feedbackEthicsGuard = exports.FeedbackEthicsGuard = void 0;
class FeedbackEthicsGuard {
     ...
     */
    checkPunishmentDemands(comment) {
        const patterns = [
...
exports.FeedbackEthicsGuard = FeedbackEthicsGuard;
exports.feedbackEthicsGuard = new FeedbackEthicsGuard();
