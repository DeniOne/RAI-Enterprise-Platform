...
exports.aiOpsGuard = exports.AIOpsGuard = void 0;
class AIOpsGuard {
    /**
     * Validate AI Output
     * Ensures strict adherence to advisory contract.
     */
    validateOutput(rawResponse) {
...
exports.AIOpsGuard = AIOpsGuard;
exports.aiOpsGuard = new AIOpsGuard();
