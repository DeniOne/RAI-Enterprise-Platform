...
exports.renderKeyboard = renderKeyboard;
 ...
 */
function renderKeyboard(actions) {
 ...
 */
function resolveActionToButton(actionId, components) {
 ...
 */
function buildKeyboardLayout(buttons) {
    const rows = [];
    let currentRow = [];
