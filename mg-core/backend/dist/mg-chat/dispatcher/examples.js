...
const result1 = (0, index_1.dispatchAction)('my_tasks');
...
const result2 = (0, index_1.dispatchAction)('main_entry');
...
const result3 = (0, index_1.dispatchAction)('unknown_intent');
...
const result4 = (0, index_1.dispatchAction)('non_existent_action');
...
const result5 = (0, index_1.dispatchAction)('');
...
const result6 = (0, index_1.dispatchAction)('cancel');
...
console.log('='.repeat(80));
function handleTelegramCallback(callbackData) {
    console.log(`\n[Telegram Callback] Received: "${callbackData}"`);
    // 1. Dispatch action
    const dispatchResult = (0, index_1.dispatchAction)(callbackData);
