...
exports.REFUSAL_MESSAGE = void 0;
exports.checkGuardrails = checkGuardrails;
exports.validateRequest = validateRequest;
exports.getRefusalMessage = getRefusalMessage;
const ai_types_1 = require("../../types/core/ai.types");
// =============================================================================
// FORBIDDEN PATTERNS
// =============================================================================
/**
 ...
 */
exports.REFUSAL_MESSAGE = 'AI Analyst не имеет права выполнять это действие. ' +
 ...
 */
function checkGuardrails(request) {
    const detected = [];
    for (const intent of ai_types_1.FORBIDDEN_INTENTS) {
    ...
    if (detected.length > 0) {
        return {
            allowed: false,
            reason: exports.REFUSAL_MESSAGE,
...
function getRefusalMessage() {
    return exports.REFUSAL_MESSAGE;
}
