...
exports.KPIEngine = exports.KPIValidationError = void 0;
// =============================================================================
// VALIDATION ERRORS
// =============================================================================
...
exports.KPIValidationError = KPIValidationError;
// =============================================================================
 ...
 */
function isInPeriod(timestamp, periodStart, periodEnd) {
 ...
 * ЧИСТАЯ ФУНКЦИЯ: нет side effects
 */
function filterByEventType(events, types) {
 ...
 * ЧИСТАЯ ФУНКЦИЯ: нет side effects
 */
function filterByPeriod(events, periodStart, periodEnd) {
 ...
 * ЧИСТАЯ ФУНКЦИЯ: нет side effects
 */
function filterByUserId(events, userId) {
...
class KPIEngine {
     ...
     */
    static calculateMultiple(formulas, events, context, calculated_at) {
        return formulas.map(formula => this.calculate({ formula, events, context, calculated_at }));
    }
}
