...
exports.recordKPIResult = recordKPIResult;
exports.recordMultipleKPIResults = recordMultipleKPIResults;
// =============================================================================
// KPI RECORDER
// =============================================================================
/**
 ...
 */
async function recordKPIResult(prisma, result, userId) {
 ...
 */
async function recordMultipleKPIResults(prisma, results, userId) {
