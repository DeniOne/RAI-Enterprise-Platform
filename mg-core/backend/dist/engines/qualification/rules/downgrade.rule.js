...
exports.riskOfDowngradeRule = void 0;
// =============================================================================
// CONSTANTS
// =============================================================================
/**
 ...
 */
function checkKPICriticallyLow(kpiName, target, input) {
 ...
 */
function hasRecentTrainingActivity(input) {
    const thirtyDaysAgo = new Date(input.evaluated_at.getTime() - 30 * 24 * 60 * 60 * 1000);
    return input.events.some(e => (e.type === 'COURSE_COMPLETED' || e.type === 'TEST_PASSED') &&
