...
exports.registryHistoryController = exports.RegistryHistoryController = void 0;
...
class RegistryHistoryController {
    ...
    async getSnapshot(req, res) {
        try {
            ...
            const event = await prisma_1.prisma.registryAuditEvent.findUnique({
                where: { id: snapshotId }
            });
...
exports.RegistryHistoryController = RegistryHistoryController;
exports.registryHistoryController = new RegistryHistoryController();
