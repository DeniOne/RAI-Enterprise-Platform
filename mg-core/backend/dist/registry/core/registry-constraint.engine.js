...
exports.registryConstraintEngine = exports.RegistryConstraintEngine = void 0;
class RegistryConstraintEngine {
    /**
     ...
     */
    async enforceDAGConstraint(tx, fromUrn, toUrn, definitionUrn) {
        ...
        if (!definition)
            throw new Error(`Relationship definition ${definitionUrn} not found`);
        ...
        const cyclePath = await tx.$queryRaw `
...
exports.RegistryConstraintEngine = RegistryConstraintEngine;
exports.registryConstraintEngine = new RegistryConstraintEngine();
