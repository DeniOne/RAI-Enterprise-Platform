...
class GrowthMatrixService {
    ...
    async getGrowthPulse(userId) {
        ...
        const monthlyEarnings = await mes_service_1.mesService.getMonthlyEarnings(userId);
        ...
        const gamification = await prisma_1.prisma.userGamificationStatus.findFirst({
            where: { user_id: userId },
            include: { status: true },
...
exports.GrowthMatrixService = GrowthMatrixService;
exports.growthMatrixService = new GrowthMatrixService();
