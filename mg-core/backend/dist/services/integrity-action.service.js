...
exports.integrityActionService = exports.IntegrityActionService = void 0;
const prisma_1 = require("../config/prisma");
const logger_1 = require("../config/logger");
class IntegrityActionService {
    /**
    ...
    async invalidateCertification(params) {
        ...
        return await prisma_1.prisma.$transaction(async (tx) => {
            ...
            logger_1.logger.info('[IntegrityActionService] Certification invalidated by human', {
     ...
     */
    async validateSignal(signalId, comment, actorId) {
        return await prisma_1.prisma.antiFraudSignal.update({
            where: { id: signalId },
            data: {
    ...
    async getSecuritySignals(filters) {
        return await prisma_1.prisma.antiFraudSignal.findMany({
            where: {
...
exports.IntegrityActionService = IntegrityActionService;
exports.integrityActionService = new IntegrityActionService();
