...
exports.antiFraudDetector = exports.AntiFraudDetector = void 0;
const anti_fraud_types_1 = require("../types/anti-fraud.types");
class AntiFraudDetector {
     ...
     */
    detectSignals(entityType, entityId, input) {
        const signals = [];
     ...
     */
    detectMetricLevel(entityType, entityId, input) {
        const signals = [];
     ...
     */
    detectBehavioralLevel(entityType, entityId, input) {
        const signals = [];
     ...
     */
    detectRuleViolationLevel(entityType, entityId, input) {
        const signals = [];
     ...
     */
    checkNoResultImprovement(entityType, entityId, input) {
        ...
        if (improvement <= 0) {
            return {
                ...
                entity_id: entityId,
                level: anti_fraud_types_1.SignalLevel.MEDIUM,
                type: anti_fraud_types_1.SignalType.NO_RESULT_IMPROVEMENT,
                metric_snapshot: {
     ...
     */
    checkExcessiveRetests(entityType, entityId, input) {
        ...
        if (excessiveModules.length > 0) {
            return {
                ...
                entity_id: entityId,
                level: anti_fraud_types_1.SignalLevel.MEDIUM,
                type: anti_fraud_types_1.SignalType.EXCESSIVE_RETESTS,
                metric_snapshot: {
     ...
     */
    checkNoProductionActivity(entityType, entityId, input) {
        ...
        if (shiftCount < threshold) {
            return {
                ...
                entity_type: entityType,
                entity_id: entityId,
                level: anti_fraud_types_1.SignalLevel.HIGH,
                type: anti_fraud_types_1.SignalType.NO_PRODUCTION_ACTIVITY,
                metric_snapshot: {
     ...
     */
    checkRoleMetricMismatch(entityType, entityId, input) {
        ...
        if (!isAllowed) {
            return {
                ...
                entity_id: entityId,
                level: anti_fraud_types_1.SignalLevel.HIGH,
                type: anti_fraud_types_1.SignalType.ROLE_METRIC_MISMATCH,
                metric_snapshot: {
                    user_role: userRole,
...
exports.AntiFraudDetector = AntiFraudDetector;
exports.antiFraudDetector = new AntiFraudDetector();
